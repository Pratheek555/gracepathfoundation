...
export default function AboutPage() {
  ...
  return (
    <main className="about-page">
      ...
      <header className="site-header"><div className="shell nav-wrap"><Link className="brand" href="/" aria-label="Gracepath Development Foundation home"><span className="logo-crop logo-crop--nav"><Image src="/gracepath/logo-transparent.png" alt="Gracepath Development Foundation" fill sizes="(max-width: 640px) 230px, (max-width: 700px) 200px, (max-width: 900px) 230px, 290px" /></span></Link><nav className="main-nav about-nav" aria-label="Main navigation"><Link className="about-nav-active" href="/about">About us</Link><Link href="/#programs">What we do</Link><Link href="/#approach">Our approach</Link><Link href="/#contact">Contact</Link><Link className="nav-cta" href="/#contact">Contact us ↓</Link></nav></div></header>
